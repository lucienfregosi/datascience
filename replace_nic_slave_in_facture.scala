//////////////////////////////////////////////////
// Nom du fichier       :  replace_nic_slave_in_facture.scala
// Description concise  :
...
.option("quote", "|")
.option("header", "true")
val dfFacture = dataFrameReader.load("/home/ig2i/data/n2.2/facture.csv")
...
val dfNicFacture = dfNicSlaveMasterFacture.join(dfFacture, dfNicSlaveMasterFacture("_1") === dfFacture("NIC"))
val dfFactureNicReplaced = dfNicFacture.select($"INTERNALTS",$"CLECOMMANDE",$"_2".alias("NIC"),$"TAUXTVA",$"TYPE",$"DATE",$"VATDEFAULTREASON",$"TOTALHT",$"CLEFACTURE",$"PERIODEDEBUT",$"PERIODEFIN",$"TOTALPOINTBONUS",$"SYSTEMFACTU",$"ZONE",$"PAYSFACTU")
